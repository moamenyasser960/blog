...
<body>
    ...
    <main id="privacy">
        ...
        <p>Welcome to munshet!</p>

        <p>These terms and conditions outline the rules and regulations for the use of munshet's Website, located at
            www.munshet.com.</p>

        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use munshet if
        ...
        <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and
            ...
            of the Company's stated services, in accordance with and subject to, prevailing law of eg. Any use of the
        ...
        <p>We employ the use of cookies. By accessing munshet, you agreed to use cookies in agreement with the munshet's
            Privacy Policy. </p>
        ...
        <p>Unless otherwise stated, munshet and/or its licensors own the intellectual property rights for all material
            on munshet. All intellectual property rights are reserved. You may access this from munshet for your own
            personal use subjected to restrictions set in these terms and conditions.</p>

        <p>You must not:</p>
        <ul>
            <li>Republish material from munshet</li>
            <li>Sell, rent or sub-license material from munshet</li>
            <li>Reproduce, duplicate or copy material from munshet</li>
            <li>Redistribute content from munshet</li>
        </ul>

        <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
            areas of the website. munshet does not filter, edit, publish or review Comments prior to their presence on
            the website. Comments do not reflect the views and opinions of munshet,its agents and/or affiliates.
            Comments reflect the views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, munshet shall not be liable for the Comments or for any liability, damages or
        ...
        <p>munshet reserves the right to monitor all Comments and to remove any Comments which can be considered
        ...
        <p>You hereby grant munshet a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
            ...
            munshet; and (d) the link is in the context of general resource information.</p>
        ...
        <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
            you must inform us by sending an e-mail to munshet. Please include your name, your organization name,
        ...
        <p>No use of munshet's logo or other artwork will be allowed for linking absent a trademark license agreement.
        </p>
